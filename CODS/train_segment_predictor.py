...
from src.models.model import SegmentPredictor
import json
...
from src.models.segmentation import solver 
import wandb
...
def run():
    ...
    # my add
    parser.add_argument("--patience", type=int, default=8, help='BERT hd')
    ...
    if args.do_train:
        ...
        solver.train_intent_predictor(predictor, args, wandb, optimizer, scheduler, train_dataloader, dev_dataloader,
                                  epochs=num_epochs, gpus=range(n_gpu), max_grad_norm=args.max_grad_norm)
